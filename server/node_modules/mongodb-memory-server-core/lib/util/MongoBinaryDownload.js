...
const log = debug_1.default('MongoMS:MongoBinaryDownload');
/**
...
class MongoBinaryDownload {
    ...
    constructor(opts) {
        ...
        utils_1.assertion(typeof opts.downloadDir === 'string', new Error('An DownloadDir must be specified!'));
        const version = (_a = opts.version) !== null && _a !== void 0 ? _a : resolveConfig_1.default(resolveConfig_1.ResolveConfigVariables.VERSION);
        utils_1.assertion(typeof version === 'string', new Error('An MongoDB Binary version must be specified!'));
        ...
        this.binaryOpts = {
            ...
            checkMD5: (_d = opts.checkMD5) !== null && _d !== void 0 ? _d : resolveConfig_1.envToBool(resolveConfig_1.default(resolveConfig_1.ResolveConfigVariables.MD5_CHECK)),
    ...
    getMongodPath() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (yield utils_1.pathExists(mongodPath)) {
    ...
    startDownload() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield mkdirp_1.default(this.downloadDir);
            try {
    ...
    download(downloadUrl) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const requestOptions = {
                ...
                protocol: resolveConfig_1.envToBool(resolveConfig_1.default(resolveConfig_1.ResolveConfigVariables.USE_HTTP)) ? 'http:' : 'https:',
            ...
            if (yield utils_1.pathExists(downloadLocation)) {
    ...
    extract(mongoDBArchive) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield mkdirp_1.default(path_1.default.dirname(mongodbFullPath));
            ...
            if (!(yield utils_1.pathExists(mongodbFullPath))) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            extract.on('entry', (header, stream, next) => {
                if (filter(header.name)) {
                    stream.pipe(fs_1.createWriteStream(extractPath, {
                        mode: 0o775,
                    }));
                }
                stream.on('end', () => next());
            ...
            return new Promise((resolve, reject) => {
                fs_1.createReadStream(mongoDBArchive)
                    .on('error', (err) => {
                ...
                yauzl_1.default.open(mongoDBArchive, { lazyEntries: true }, (e, zipfile) => {
                    ...
                    zipfile.on('entry', (entry) => {
                        ...
                        zipfile.openReadStream(entry, (e, r) => {
                            ...
                            r.pipe(fs_1.createWriteStream(extractPath, {
                                mode: 0o775,
                            }));
                        });
                    });
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                https_1.default
                    ...
                    const fileStream = fs_1.createWriteStream(tempDownloadLocation);
                    response.pipe(fileStream);
                    fileStream.on('finish', () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                        var _a;
    ...
    printDownloadProgress(chunk, forcePrint = false) {
        ...
        if (process.stdout.isTTY) {
            ...
            readline_1.clearLine(process.stdout, 0); // this is because "process.stdout.clearLine" does not exist anymore
